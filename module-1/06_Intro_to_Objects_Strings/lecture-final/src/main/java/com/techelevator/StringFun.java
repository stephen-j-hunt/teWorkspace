...
//        }
        ...
        System.out.println(hello.indexOf("not found")); // -1 if not found in the string
        ...
        System.out.println("hello WORLD".toLowerCase().contains("WOR".toLowerCase()));
...
//        }
        ...
        // replace
        System.out.println(hello.replace("hello", "goodbye")); // hello is not changed. a new string is created
