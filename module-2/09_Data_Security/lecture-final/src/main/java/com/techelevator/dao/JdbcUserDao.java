...
public class JdbcUserDao implements UserDao {
    ...
    public boolean isUsernameAndPasswordValid(String userName, String password) {
        ...
        if (results.next()) {
            ...
            String storedPasswordHash = results.getString("password");
            String hashOfGivenPassword = passwordHasher.computeHash(password, Base64.decode(storedSalt));
            return storedPasswordHash.equals(hashOfGivenPassword);
        } else {
            return false;
        }
    }
