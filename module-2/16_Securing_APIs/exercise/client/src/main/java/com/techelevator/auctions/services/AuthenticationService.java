...
public class AuthenticationService {
    ...
    public String login(String username, String password) {
        ...
        String token = null;
        try {
            ResponseEntity<TokenDto> tokenReceived = restTemplate.exchange(API_BASE_URL + "login",HttpMethod.POST, entity, TokenDto.class);
            TokenDto body = tokenReceived.getBody();
            if (body != null) {
                token= body.getToken();
            }
