...
public class HotelService {
    ...
    public Reservation addReservation(Reservation newReservation) {
        ...
        HttpEntity<Reservation> payload = this.makeReservationEntity(newReservation);
        this.restTemplate.postForObject(API_BASE_URL+"reservations",
                payload,
                Reservation.class);
    ...
    public boolean updateReservation(Reservation updatedReservation) {
        ...
        try {
            restTemplate.put(
                    API_BASE_URL + "reservations/" + updatedReservation.getId(),
