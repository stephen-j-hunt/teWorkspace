...
FROM city
WHERE state_abbreviation <> 'CA'; -- not in
...
SELECT park_name, (area*1000000) AS area_in_sq_meters
FROM park;
...
-- BETWEEN
-- Write a query to retrieve the names and areas of parks of at least 100 sq. 
-- kilometers but no more than 200 sq. kilometers
SELECT park_name
FROM park
